...
//
//     final globeData = globeDataFromJson(jsonString);

import 'dart:convert';

GlobeData generalDataModelFromJson(String str) => GlobeData.fromJson(json.decode(str));

String generalDataModelToJson(GlobeData data) => json.encode(data.toJson());

class GlobeData {
  final List<Result> results;
  final String stat;

  GlobeData({this.results, this.stat});
